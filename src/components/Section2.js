...
const Section2 = () => (
	<div className="relative bg-[#1602AS]">
		<img src="/coins/token.svg" className="absolute w-40 -top-20 left-64" />
		<img src="/coins/token2.svg" className="absolute w-28 -bottom-20 right-64" />
		<div className="bg-[#160A2F] md:px-10">
			<div className="container mx-auto bg-[#FEDB9E] py-24 rounded px-8 xl:px-32">
				<div className="flex flex-col justify-between items-center">
					...
					<div className="flex justify-center xl:justify-between flex-wrap my-16">
						<div  className="xl:w-3/12 md:max-w-2xl offset-border text-center px-10 my-8  sm:w-11/12 bg-[#EBE8E3]">
