				...
				<div className="flex flex-col justify-center items-center">
					...
					<div className="flex justify-evenly flex-wrap my-16">
						<div  className="lg:w-3/12 section-2-card text-center px-14 my-8">
							...
							<div className="text-lg	text-center px-2 mb-10" >Receive up to $1M from. Apply in 15 minutes and you&apos;ll recieve a decision within a few days</div>
				 		</div>
						<div className="lg:w-3/12 section-2-card text-center px-14 my-8">
					...
					<Link href={links[0]}>
						<a target="_https://vision.hyperscale">
