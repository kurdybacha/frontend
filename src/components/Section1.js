...
const Section1 = () => (
	<div className=" bg-[#1602AS] pb-16 lg:pb-32 px-6 md:px-10 bg-noise">
		<Header />
		<div className="container mx-auto flex flex-col-reverse lg:flex-row justify-between items-center space-x-2 pt-16 pb-32 lg:pb-24 xl:px-32">
